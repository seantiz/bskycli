...
impl PostViewModel {
    ...
    fn from_post_view_inner(
        ...
        Some(PostViewModel {
            ...
            display_name: author.display_name.clone().unwrap(),
            avatar: author.avatar.clone(),
            text,
            facets,
            created_at: created_at_time,
            likes: post.like_count.unwrap(),
            reposts: post.repost_count.unwrap(),
            replies: post.reply_count.unwrap(),
            quote_count: post.quote_count.unwrap(),
            is_liked,
            like_uri,
            is_reposted,
            repost_uri,
