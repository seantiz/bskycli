...
**As of version 0.4.4** this app does the job and gives a completely secure Bluesky experience. 

Please note: A significant part of the ui depends on you using a PTY like kitty, especially for images.
